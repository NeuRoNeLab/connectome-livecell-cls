...
from models.configs import OptimizerType, LRSchedulerConfig, LRSchedulerType, resolve_optimizer, resolve_lr_scheduler, \
    resolve_metric
from models.vision.vit import CustomViTConfig, CustomViT, CustomViTOutput


class CustomViTLossType(str, Enum):
    CROSS_ENTROPY = "cross_entropy"
    CUSTOM = "custom"


class CustomViTWrapper(lit.LightningModule):

    def __init__(self,
                 config: CustomViTConfig,
                 loss_type: CustomViTLossType = CustomViTLossType.CROSS_ENTROPY,
        ...
        self._loss_type: CustomViTLossType = loss_type
    ...
    @property
    def loss_type(self) -> CustomViTLossType:
    ...
    def _step(self, batch, batch_idx, step_type: str, *args, **kwargs) -> STEP_OUTPUT:
        ...
        if target.dtype == torch.long or self.loss_type == CustomViTLossType.CROSS_ENTROPY:
