...
from models.configs import OptimizerType, LRSchedulerConfig, LRSchedulerType, resolve_optimizer, resolve_lr_scheduler, \
    resolve_metric
from models.elegansformer.elegans_swin import ElegansSwin, ElegansSwinOutput, ElegansSwinConfig


class ElegansSwinLossType(str, Enum):
    CROSS_ENTROPY = "cross_entropy"
    CUSTOM = "custom"


class ElegansSwinWrapper(lit.LightningModule):

    def __init__(self,
                 config: ElegansSwinConfig,
                 loss_type: ElegansSwinLossType = ElegansSwinLossType.CROSS_ENTROPY,
        ...
        self._loss_type: ElegansSwinLossType = loss_type
        ...
        self._elegans_swin = ElegansSwin(config)
    ...
    @property
    def loss_type(self) -> ElegansSwinLossType:
    ...
    @property
    def elegans_swin(self) -> ElegansSwin:
        return self._elegans_swin
    ...
    def configure_optimizers(self):
        ...
        # Get the parameters
        model_params = self.elegans_swin.named_parameters()
    ...
    def _step(self, batch, batch_idx, step_type: str, *args, **kwargs) -> STEP_OUTPUT:
        ...
        if target.dtype == torch.long or self.loss_type == ElegansSwinLossType.CROSS_ENTROPY:
